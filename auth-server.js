// 🚀 ENTRY POINT che avvia il server corretto// 🔄 REDIRECT FORZATO al server corretto// 🔄 REDIRECT FORZATO al server corretto// 🔄 REDIRECT FORZATO al server corretto

console.log('🔄 Entry point - avvio simple-server.js');

require('./simple-server.js');console.log('🔄 auth-server.js deprecato - redirect a simple-server.js');

console.log('🚀 Avvio del server corretto...');console.log('🔄 auth-server.js deprecato - redirect a simple-server.js'); console.log('🔄 auth-server.js deprecato - redirect a simple-server.js');



// Avvia il server correttoconsole.log('🚀 Avvio del server corretto...'); console.log('🚀 Avvio del server corretto...');
